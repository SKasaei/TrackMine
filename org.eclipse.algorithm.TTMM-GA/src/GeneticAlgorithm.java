...
/*
	...
	*/	
			...
			ArrayList<Chromosome> populationTemp = new ArrayList<Chromosome>();
	//		populationTemp = prepNextGeneration();
			for (int pi = 0; pi < populationSize; pi++)
				{
				populationTemp.add(population.get(0));
				population.remove(0);
				}
			getFitness();
			population.addAll(populationTemp);

		//	population.add(populationTemp.get(0));
			
		//	START_SIZE = population.size();
